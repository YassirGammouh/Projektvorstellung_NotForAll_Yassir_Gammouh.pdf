...
* [**Hier die Projekt-Präsentation ansehen (PDF)**](NotForAll_Schmuck_Marke_Darstellung_Yassir_Gammouh.pdf)

## 🚀 Kern-Features des Projekts
* **Branding:** Entwicklung eines Logos und Corporate Designs.
* **Web-Design:** Erstellung eines modernen User Interfaces (UI).

## 🛠 Verwendete Tools
* **Präsentation:** Microsoft PowerPoint / PDF
* **Design:**  Photoshop oder Canva
* **Web:**shopify und sonstige webseiten platformen

---
*Erstellt von Yassir Gammouh*
